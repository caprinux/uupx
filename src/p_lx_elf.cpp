...
static const UPXStubRef upx_known_stubs_amd64[] = {
    { upx_stub_amd64,     sizeof(upx_stub_amd64)     }, // current build
    { upx_stub_amd64_old, sizeof(upx_stub_amd64_old) }, // older variant
};
static const UPXStubRef upx_known_stubs_i386[] = {
    { upx_stub_i386,      sizeof(upx_stub_i386)      }, // current build
};
